...
import { ComboboxItemDto, NhomDinhDuongServiceProxy } from '@shared/service-proxies/service-proxies';
import { AppUtilityService } from '@app/shared/common/custom/utility.service';
import { DataCommonService } from '@app/shared/data-common/data-common.service';

const VALUE_ACCESSOR: Provider = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => NhomDinhDuongComboComponent),
    multi: true,
};

@Component({
    selector: 'nhom-dinh-duong-combo',
    template: `
...
export class NhomDinhDuongComboComponent extends AppComponentBase implements OnInit, ControlValueAccessor {
    ...
    async ngOnInit() {
        const that = this;
        this.optionList = await this._comboboxService.getComboboxData('nhomdinhduong', that._dataService.comboBoxData());
