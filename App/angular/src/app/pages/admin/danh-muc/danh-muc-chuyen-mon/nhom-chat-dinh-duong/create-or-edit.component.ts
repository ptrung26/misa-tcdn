...
import {NhomDinhDuongDto, NhomDinhDuongServiceProxy} from '@shared/service-proxies/service-proxies';
...
export class CreateOrEditNhomChatDinhDuongComponent extends ModalComponentBase implements OnInit {
    @Input() dataItem: NhomDinhDuongDto;
