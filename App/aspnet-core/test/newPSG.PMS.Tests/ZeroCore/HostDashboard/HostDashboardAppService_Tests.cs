...
using newPSG.PMS.MultiTenancy.HostDashboard;
...
namespace newPSG.PMS.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(PMSDbContext context, SubscriptionPayment subscriptionPayment)
        {
