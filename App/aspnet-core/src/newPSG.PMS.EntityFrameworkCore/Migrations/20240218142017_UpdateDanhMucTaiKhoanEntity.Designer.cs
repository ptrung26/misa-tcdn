...
namespace newPSG.PMS.Migrations
{
    ...
    [Migration("20240218142017_UpdateDanhMucTaiKhoanEntity")]
    partial class UpdateDanhMucTaiKhoanEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("newPSG.PMS.AppCore.FireBaseServer.UserFireBaseToken", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("newPSG.PMS.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("newPSG.PMS.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("newPSG.PMS.Chat.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("newPSG.PMS.Entities.DanhMucTaiKhoanEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<bool>("CoHachToanNgoaiTe")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("CoTaiKhoanNganHang")
                        .HasColumnType("tinyint(1)");

                    b.Property<int?>("CongTrinh")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("DoiTuongTHCP")
                        .HasColumnType("int");

                    b.Property<int?>("DonDatHang")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("HopDongBan")
                        .HasColumnType("int");

                    b.Property<int?>("HopDongMua")
                        .HasColumnType("int");
                    ...
                    b.ToTable("DM_TaiKhoan");
                });

            modelBuilder.Entity("newPSG.PMS.Friendships.Friendship", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("newPSG.PMS.MultiTenancy.Accounting.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("newPSG.PMS.MultiTenancy.Payments.SubscriptionPayment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("newPSG.PMS.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("newPSG.PMS.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("newPSG.PMS.Storage.BinaryObject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("newPSG.PMS.Editions.SubscribableEdition", b =>
                {
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("newPSG.PMS.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("newPSG.PMS.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("newPSG.PMS.Authorization.Roles.Role", b =>
                {
                    b.HasOne("newPSG.PMS.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("newPSG.PMS.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("newPSG.PMS.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("newPSG.PMS.Entities.DanhMucTaiKhoanEntity", b =>
                {
                    b.HasOne("newPSG.PMS.Entities.DanhMucTaiKhoanEntity", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId");
                });
