...
namespace newPSG.PMS.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var dashboard = administration.CreateChildPermission(AppPermissions.Pages_Administration_Host_Dashboard, L("Dashboard"), multiTenancySides: MultiTenancySides.Host);
            dashboard.CreateChildPermission(AppPermissions.Pages_Dashboard_BS, L("Dashboard_BS"), multiTenancySides: MultiTenancySides.Host);
            dashboard.CreateChildPermission(AppPermissions.Pages_Dashboard_NBT, L("Dashboard_NBT"), multiTenancySides: MultiTenancySides.Host);
            ...
            #region Đơn vị cơ sở
            pages.CreateChildPermission(AppPermissions.Pages_DonViCoSo, L("Pages_DonViCoSo"));
            #endregion
        }
