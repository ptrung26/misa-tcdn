...
using newPSG.PMS.DashboardCustomization;
...
namespace newPSG.PMS.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        public override IEnumerable<SettingDefinition> GetSettingDefinitions(SettingDefinitionProviderContext context)
        {
            ...
            var res = GetHostSettings().Union(GetTenantSettings()).Union(GetSharedSettings())
                // theme settings
        ...
        private IEnumerable<SettingDefinition> GetTenantSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings, GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings, PMSConsts.MultiTenancyEnabled? "true":"false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(AppSettings.DashboardCustomization.Configuration +"."+ PMSDashboardCustomizationConsts.Applications.Mvc, mvcDefaultSettingsJson, scopes: SettingScopes.User, isVisibleToClients: true),
                new SettingDefinition(AppSettings.DashboardCustomization.Configuration +"."+ PMSDashboardCustomizationConsts.Applications.Angular, angularDefaultSettingsJson, scopes: SettingScopes.User, isVisibleToClients: true)
            };
        }
        ...
        public List<Dashboard> GetDefaultMvcDashboardViews()
        {
            ...
            return new List<Dashboard>
            {
                new Dashboard
                {
                    DashboardName = PMSDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            Name = PMSDashboardCustomizationConsts.DefaultPageName,
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = PMSDashboardCustomizationConsts.Widgets.Tenant.GeneralStats, // General Stats
                                    Height = 9,
                                    Width = 6,
                                    PositionX = 0,
                                    PositionY = 19
                                ...
                                new Widget
                                {
                                    WidgetId = PMSDashboardCustomizationConsts.Widgets.Tenant.ProfitShare, // Profit Share
                                    Height = 13,
                                    Width = 6,
                                    PositionX = 0,
                                    PositionY = 28
                                ...
                                new Widget
                                {
                                    WidgetId = PMSDashboardCustomizationConsts.Widgets.Tenant.MemberActivity, // Memeber Activity
                                    Height = 13,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 28
                                ...
                                new Widget
                                {
                                    WidgetId = PMSDashboardCustomizationConsts.Widgets.Tenant.RegionalStats, // Regional Stats
                                    Height = 14,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 5
                                ...
                                new Widget
                                {
                                    WidgetId = PMSDashboardCustomizationConsts.Widgets.Tenant.DailySales, // Daily Sales
                                    Height = 9,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 19
                                ...
                                new Widget
                                {
                                    WidgetId = PMSDashboardCustomizationConsts.Widgets.Tenant.TopStats, // Top Stats
                                    Height = 5,
                                    Width = 12,
                                    PositionX = 0,
                                    PositionY = 0
                                ...
                                new Widget
                                {
                                    WidgetId = PMSDashboardCustomizationConsts.Widgets.Tenant.SalesSummary, // Sales Summary
                                    Height = 14,
                                    Width = 6,
                                    PositionX = 0,
                                    PositionY = 5
                ...
                new Dashboard
                {
                    DashboardName = PMSDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = PMSDashboardCustomizationConsts.Widgets.Host.TopStats, // Top Stats
                                    Height = 6,
                                    Width = 12,
                                    PositionX = 0,
                                    PositionY = 0
                                ...
                                new Widget
                                {
                                    WidgetId = PMSDashboardCustomizationConsts.Widgets.Host.IncomeStatistics, // Income Statistics
                                    Height = 11,
                                    Width = 7,
                                    PositionX = 0,
                                    PositionY = 6
                                ...
                                new Widget
                                {
                                    WidgetId = PMSDashboardCustomizationConsts.Widgets.Host.RecentTenants, // Recent tenants
                                    Height = 10,
                                    Width = 5,
                                    PositionX = 7,
                                    PositionY = 17
                                ...
                                new Widget
                                {
                                    WidgetId = PMSDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants, // Subscription expiring tenants
                                    Height = 10,
                                    Width = 7,
                                    PositionX = 0,
                                    PositionY = 17
                                ...
                                new Widget
                                {
                                    WidgetId = PMSDashboardCustomizationConsts.Widgets.Host.EditionStatistics, // Edition statistics
                                    Height = 11,
                                    Width = 5,
                                    PositionX = 7,
                                    PositionY = 6
                    ...
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                ...
                                new Widget
                                {
                                    WidgetId = PMSDashboardCustomizationConsts.Widgets.Tenant.MemberActivity, // Member Activity
                                    Height = 11,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 24
                    ...
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                ...
                                {
                                    WidgetId =
                                        PMSDashboardCustomizationConsts.Widgets.Host.RecentTenants, // Recent tenants
                                    Height = 9,
                                    Width = 5,
                                    PositionX = 7,
                                    PositionY = 12
        ...
        private IEnumerable<SettingDefinition> GetCHTDTuyChinhSettings()
        {
            return new[] {
                #region Cấu hình thực đơn TE
                new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomBot, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomBot, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomChao, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomChao, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomTraiCay, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomTraiCay, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomBanhKeo, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomBanhKeo, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomSuaChua, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomSuaChua, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomVangSua, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomVangSua, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomPhoMai, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomPhoMai, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomBanhFlan, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomBanhFlan, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomSuaCongThuc, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTE.MaNhomSuaCongThuc, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                #endregion END cấu hình thực đơn TE
                 #region Cấu hình thực đơn TE AC
                 new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTEAC.MaNhomSua, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTEAC.MaNhomSua, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTEAC.MaNhomBanhKeo, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTEAC.MaNhomBanhKeo, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTEAC.MaNhomTraiCay, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTEAC.MaNhomTraiCay, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTEAC.MaNhomNuocGiaiKhat, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTEAC.MaNhomNuocGiaiKhat, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTEAC.MaNhomSpTuSua, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTEAC.MaNhomSpTuSua, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTEAC.MaNhomCom, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTEAC.MaNhomCom, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTEAC.MaNhomMonAnCungCom, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTEAC.MaNhomMonAnCungCom, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTEAC.MaNhomKhacCom, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTEAC.MaNhomKhacCom, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                #endregion END cấu hình thực đơn AC

                #region Cấu hình thực đơn trẻ sơ sinh
                   new SettingDefinition(AppSettings.CHTDTuyChinhManagement.ThucDonTSS.MaNhomSua, GetFromAppSettings(AppSettings.CHTDTuyChinhManagement.ThucDonTSS.MaNhomSua, "[]"), isVisibleToClients: true, scopes: SettingScopes.All),
                #endregion
