...
namespace newPSG.PMS.Web.Models.TokenAuth
{
    ...
    public class AuthenticateNguoiDungInput
    {
        public AuthenticateSimpleModel AuthenModal { get; set; }
        public CreateOrEditUserFireBaseTokenDto FireBaseToken { get; set; }
    }
    public class AuthenticateSimpleModel
    {
        [Required]
        [MaxLength(AbpUserBase.MaxEmailAddressLength)]
        public string UserNameOrEmailAddress { get; set; }
