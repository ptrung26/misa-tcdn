...
using newPSG.PMS.DashboardCustomization.Definitions;
using newPSG.PMS.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace newPSG.PMS.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : PMSAppServiceBase, IDashboardCustomizationAppService
    {
