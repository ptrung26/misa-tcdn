...
using newPSG.PMS.Core.Base;
using newPSG.PMS.Core.Extensions;
using newPSG.PMS.Dto;
using newPSG.PMS.Types;

namespace newPSG.PMS.Queries
{
    public class OrganizationUnitQuery : PMSQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
